#ifndef KINE_DRC_HUBO3_H
#define KINE_DRC_HUBO3_H
...
public:
    ...
    IK_RETURN_CODE IK_LowerBody_Global(const double Qinit_34x1[],
                                       const double Q_ub_34x1[], const double des_pCOM_2x1[], double des_pPCz, const double des_qPEL_4x1[],
    ...
    IK_RETURN_CODE IK_LowerBody_Local(const double Qinit_34x1[],
                           const double des_pRF_3x1[], const double des_qRF_4x1[],
                           const double des_pLF_3x1[], const double des_qLF_4x1[],
                           double Q_return_34x1[]);
...
public:
    ...
    int IK_RH_Local(const double Qinit_34x1[],
                    const double des_pRH_3x1[], const double des_qRH_4x1[], double des_RElb_ang,
                    double des_wst_ang,
                    double Q_return_34x1[]);

    int IK_LH_Local(const double Qinit_34x1[],
                    const double des_pLH_3x1[], const double des_qLH_4x1[], double des_LElb_ang,
                    double des_wst_ang,
                    double Q_return_34x1[]);
