...
int QT2PRY(const double qt_4x1[], double &pit, double &rol, double &yaw);
...
void pivot(const double a_nxn[], double p_nxn[], int n);
void LU(const double A_nxn[], double L_nxn[], double U_nxn[], int n);
double det(const double A_nxn[], int n);
double det(const double A_nxn[], double U_diag_nx1[], int n);
