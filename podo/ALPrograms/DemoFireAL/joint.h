...
public:
    ...
    int             ReferenceReadyFlag;
    void            SetReferenceReady()     {ReferenceReadyFlag = 1;}
    void            ClearReferenceReady()   {ReferenceReadyFlag = 0;}
    int             CheckReferenceReady()   {if(ReferenceReadyFlag == 1) return true;
                                            else return false;}
};
